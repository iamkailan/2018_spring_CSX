...
tweets <- search_tweets("#Metoo", n =8000, type = "recent", include_rts = TRUE, token = twitter_token, geocode = "40.72375777435207,-73.98553349666315,100mi")
...
jpeg("plot_wordcloud_uniqueusers_dark.jpeg", width = 5, height = 5, units = 'in', res = 300)
par(bg = 'black')
wordcloud(hashtags_unique_df[2:50,1], hashtags_unique_df[2:50,3], random.order=F,
          colors =  pal) 
dev.off()
